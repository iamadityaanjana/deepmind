...
export default function FeaturesPlanet() {
  return (
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900" id="0">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              DeepMind AI helps you learn faster and efficiently.
            </h2>
          </div>
          {/* Planet */}
            ...
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-linear-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-blue-500),transparent)]">
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  ...
                  <div>
                    <h3
                      className="absolute -left-28 text-white font-sans top-16 z-10 animate-[float_4s_ease-in-out_infinite_both]  transition-opacity duration-500"
                      
                    >Learn from anywhere you want</h3>
                    <h3
                      className="absolute text-white font-sans left-56 top-7 z-10 animate-[float_4s_ease-in-out_infinite_1s_both]  transition-opacity duration-500"
                      
                    >Concepts explained in a way that you can understand</h3>
                    <h3
                    className="absolute text-white font-sans -left-20 bottom-24 z-10 animate-[float_4s_ease-in-out_infinite_2s_both] transition-opacity duration-500"
                      
                    >Learning at your fingertips</h3>
                    <h3
                      className="absolute text-white font-sans bottom-32 left-64 z-10 animate-[float_4s_ease-in-out_infinite_3s_both] transition-opacity duration-500"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Get instant access to a wide range of learning materials, including videos, quizzes, and interactive exercises.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Utilize AI-driven learning tools to tailor your learning experience, including personalized quizzes, flashcards, and study plans.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Learn with examples as code snippets.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
              Personalized study paths based on your progress.
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
              Infographics, videos, and real-world examples.
